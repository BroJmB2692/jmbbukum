...
<head>
  ...
  <style>
    ...
    .card {
      background: white;
      padding: 0.25rem 2.5rem 2.5rem 2.5rem; /* top right bottom left */
      border-radius: 12px;
...
<body>
  ...
  <div class="container">
    ...
    <header>
      <h1>Buku Market, LLC</h1>
      <p class="tagline">Technology Solutions • Automation • Digital Services</p>
    </header>
